...
# Project information
project = "Ansys Scade One Actions"
...
html_theme_options = {
    "github_url": "https://github.com/ansys/scadeone-actions",
...
linkcheck_ignore = [
    r"https://github.com/ansys/scadeone-actions*",
]
